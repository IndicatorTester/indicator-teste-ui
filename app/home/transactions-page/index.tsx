...
const TransactionsPage = () => {
    return (
        <div className="snap-center h-screen w-screen flex flex-col lg:flex-row lg:items-stretch items-center px-16 py-16">
            <div className="flex flex-col justify-start lg:mt-32 lg:w-1/2">
                ...
                <p className="text-gray-400 lg:text-start text-center text-lg font-light md:text-2xl">
                    ...
                    know the quality of your indicator then <u>optimize it</u>.
                </p>
            </div>
