            ...
            <div className="col-span-8 row-span-1 min-h-screen">
                <div className="w-full">
                    ...
                    <p>
                        ...
                        terms and conditions. Do not continue to use XIndicator
                    ...
                    <br />
                    <p>
                        Unless otherwise stated, XIndicator and/or its licensors
                        own the intellectual property rights for all material on
                        XIndicator. All intellectual property rights are
                        reserved. You may access this from XIndicator for your
                    ...
                    <br />
                    <ul>
                        <li>Republish material from XIndicator</li>
                        <li>
                            Sell, rent or sub-license material from XIndicator
                        </li>
                        <li>
                            Reproduce, duplicate or copy material from
                            XIndicator
                        </li>
                        <li>Redistribute content from XIndicator</li>
                    </ul>
                    <br />
                    <p>
                    ...
                    <br />
                    <p>
                        XIndicator reserves the right to monitor all Comments
                    ...
                    <br />
                    <p>
                        You hereby grant XIndicator a non-exclusive license to
                    ...
                    <p>
                        ...
                        XIndicator; and (d) the link is in the context of
                    ...
                    <p>
                        ...
                        you must inform us by sending an e-mail to XIndicator.
