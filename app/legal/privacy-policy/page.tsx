        ...
        <>
            ...
            <div className="col-span-8 row-span-1">
                <div className="w-full">
                    ...
                    <br/>
                    <p className="font-light text-sm" >Last updated: December 22, 2023</p>
                    <br/>
                    <p>
                    ...
                    <br/>
                    <h2 className="font-black text-xl">Interpretation and Definitions</h2>
                    <br/>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this
                                Agreement) refers to XIndicator.
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                <strong>Country</strong> refers to: United
                                Kingdom
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to XIndicator,
                                accessible from{" "}
                                <a
                                    href="https://www.xindicator.com"
                    ...
                    <br/>
                    <h2 className="font-black text-xl">Collecting and Using Your Personal Data</h2>
                    <br/>
                    ...
                    <br/>
                    <h4 className="font-bold text-md">Information from Third-Party Social Media Services</h4>
                    <br/>
                    <p>
                    ...
                    <br/>
                    <h2 className="font-black text-xl">Changes to this Privacy Policy</h2>
                    <br/>
                    <p>
                    ...
                    <br/>
                    <ul>
                        <li>By email: support@xindicator.com</li>
                    </ul>
                </div>
            </div>
            <div className="col-span-2"></div>
